/*
 * Binish Mathew 09-10-2022
 * Copied from https://gist.github.com/sam016/4abe921b5a9ee27f67b3686910293026
 */
...
object GattUtilities {
    ...
    object GattCharacteristics {
        ...
        fun lookup(uuid: UUID) : CharSequence? {
            return lookup(uuid.toString())
        }

        fun lookup(uuid: String): CharSequence? {
